import { Box, Grid, makeStyles, Typography, Table, TableBody, TableCell, TableRow } from '@material-ui/core';
            ...
            {product && Object.keys(product).length &&
                <Grid className={classes.container}>
                    ...
                    <Grid item lg={8} md={8} sm={8} xs={12} className={classes.rightContainer}>
                        ...
                        <Typography style={{ msrginTop: 20, fontWeight: 600 }}>Available Offers</Typography>
